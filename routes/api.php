...
Route::apiResource("vendor_expenses/this_month/get", 'VendorExpenseController@this_month');
Route::apiResource("vendor_expenses/last_month/get", 'VendorExpenseController@last_month');